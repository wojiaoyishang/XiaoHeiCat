interface IconProps {
  name: 'save' | 'new' | 'rename' | 'delete' | 'sync' | 'restart' | 'syncRestart' | 'run' | 'terminal' | 'refresh' | 'clear' | 'hide' | 'apps' | 'scripts' | 'leftPanel' | 'rightPanel' | 'debug' | 'stop' | 'generator'
}
...
const paths: Record<IconProps['name'], string> = {
  ...
  generator: 'M4 5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5Zm8 0H6v14h10V9h-4V5Zm-3.8 7.2L6.4 14l1.8 1.8-1.4 1.4L3.6 14l3.2-3.2 1.4 1.4Zm7.6 0 1.4-1.4 3.2 3.2-3.2 3.2-1.4-1.4 1.8-1.8-1.8-1.8Zm-3.1-1.9 1.9.6-3.3 6.8-1.9-.6 3.3-6.8Z'
}
