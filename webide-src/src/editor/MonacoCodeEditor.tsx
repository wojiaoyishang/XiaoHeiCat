...
export function MonacoCodeEditor({
    ...
    useEffect(() => {
        ...
        const mouseSub = editorRef.current.onMouseDown((event) => {
            ...
            // Monaco 会把左侧 gutter 明确分成三块：
            // - GUTTER_GLYPH_MARGIN：断点/图标区域
            // - GUTTER_LINE_NUMBERS：行号区域
            // - GUTTER_LINE_DECORATIONS：折叠箭头等装饰区域
            // 断点只响应 glyph margin 和行号；不要响应 line decorations，否则点击折叠箭头会误切断点。
